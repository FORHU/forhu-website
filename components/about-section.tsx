...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="relative py-32 px-6 bg-background font-poppins">
      <div className="relative z-10 max-w-7xl mx-auto">
        {/* Main heading */}
        <div className="text-center mb-20">
          <span className="text-accent text-sm font-bold uppercase tracking-widest">ABOUT US</span>
          <h2 className="text-4xl md:text-5xl font-bold mt-4 text-foreground mb-8 leading-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {aboutItems.map((item, index) => (
            <div
              ...
              className={`group p-10 rounded-2xl border border-border/50 bg-card/30 backdrop-blur-sm transition-all duration-700 transform ${visibleItems[index] ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            ...
            >
              <div className="h-1 w-12 bg-accent/50 mb-8 rounded-full group-hover:w-20 transition-all duration-500"></div>
