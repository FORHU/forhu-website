  ...
  return (
    <section className="relative overflow-hidden min-h-screen pt-24 pb-16 sm:pt-32 sm:pb-32 px-4 sm:px-6 lg:px-8 flex items-center">
      ...
      <div className="mx-auto max-w-6xl w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          >
            <div className="relative w-full max-w-xs sm:max-w-sm">
              ...
              <div className="relative p-8 sm:p-12 rounded-2xl border border-accent/40 bg-white/[0.04] backdrop-blur-sm shadow-lg shadow-black/30 text-center">
        ...
        {/* Solution Box */}
        <div
          className={`mb-12 p-6 sm:p-8 rounded-2xl border border-white/8 bg-white/[0.04] backdrop-blur-sm shadow-lg shadow-black/30 transition-all duration-1000 ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
