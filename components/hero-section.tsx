  ...
  return (
    <section className="relative overflow-hidden min-h-screen pt-24 pb-16 sm:pt-32 sm:pb-32 px-4 sm:px-6 lg:px-8 flex items-center">
      ...
      <div className="mx-auto max-w-6xl w-full">
        ...
        {/* Main Headline */}
        <h1
          className={`mb-8 text-4xl sm:text-6xl lg:text-8xl font-bold tracking-tighter text-foreground text-balance transition-all duration-1000 leading-tight text-center sm:text-left ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
        >
